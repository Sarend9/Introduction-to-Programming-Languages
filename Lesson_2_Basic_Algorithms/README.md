...
- Код: [`Task1_SquareNumber`](Task1_SquareNumber/Program.cs)
...
- Код: [`Task2_MaxMin`](Task2_MaxMin/Program.cs)
...
- Код: [`Task3_DayOfWeekByNumber`](Task3_DayOfWeekByNumber/Program.cs)
...
- Код: [`Task4_MaxOfThree`](Task4_MaxOfThree/Program.cs)
...
- Код: [`Task6_IsEven`](Task6_IsEven/Program.cs)
...
- Код: [`Task8_EvenNumbers`](Task8_EvenNumbers/Program.cs)
